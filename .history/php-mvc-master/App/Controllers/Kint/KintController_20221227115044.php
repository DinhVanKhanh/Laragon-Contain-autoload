...
class KintController extends \Core\Controller
{
	...
	public static function login($driver)
	{
		...
		$idInput = $driver->findElement(WebDriverBy::cssSelector('txtUname'))->sendKeys('admin');
		$passInput = $driver->findElement(WebDriverBy::cssSelector('txtUname'))->sendKeys('admin');
