...
class KintController extends \Core\Controller
{
	...
	public function indexAction()
	{
		...
		sleep(2);
		// KintController::importFileCSV($driver);
		// sleep(2);
		$checkSearch = KintController::search($driver);
		if (!$checkSearch) {
			sleep(2);
			//reset search
			$el = $driver->findElement(WebDriverBy::cssSelector("#resetbtn"))->click();
			KintController::insert($driver);
		}
		sleep(2);
		KintController::edit($driver);
		sleep(2);
		KintController::delete($driver);
