 ...
 * PHP version 7.0
 */
class SospController extends \Core\Controller
{
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/contact.php"]'));
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="javascript:OpenWinForm(\'/partner/sosp/member/form\')"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/news.php"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/mag.php"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/download.php"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/faq.php"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
	...
	{
		$el = $driver->findElement(WebDriverBy::cssSelector('.sidebar-top a[href="/partner/sosp/member/solution.php"]'));
		$el->getLocationOnScreenOnceScrolledIntoView();
		sleep(3);
		$el->click();
		sleep(3);
